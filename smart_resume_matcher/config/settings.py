...
DEBUG = config('DEBUG', default=True, cast=bool)  # Default to True for easier debugging
...
# Static files storage for production - simplified for Railway
...
# CORS settings - more permissive for deployment
